...
export const BOSSES = [
  ...
  // ===== PHASE 7.5 — biome legendary bosses (unique art, 3 phases) =====
  { id: 'rot_mother', name: 'The Rot Mother', texture: 'boss_jungle', hp: 6000, speed: 44, dmg: 42, scale: 1.3,
    phases: [
      { at: 1.0, attacks: ['spiral', 'summon'] },
      { at: 0.6, attacks: ['spiral', 'nova', 'summon'] },
      { at: 0.3, attacks: ['spiral', 'nova', 'summon', 'charge'] },
    ] },
  { id: 'myconid_king', name: 'Myconid King', texture: 'boss_mush', hp: 7800, speed: 40, dmg: 46, scale: 1.35,
    phases: [
      { at: 1.0, attacks: ['nova', 'summon'] },
      { at: 0.55, attacks: ['nova', 'spiral', 'summon'] },
      { at: 0.25, attacks: ['nova', 'spiral', 'summon', 'charge'] },
    ] },
  { id: 'frost_titan', name: 'The Frost Titan', texture: 'boss_frost', hp: 9600, speed: 38, dmg: 52, scale: 1.4,
    phases: [
      { at: 1.0, attacks: ['charge', 'spiral'] },
      { at: 0.6, attacks: ['charge', 'spiral', 'nova'] },
      { at: 0.3, attacks: ['charge', 'spiral', 'nova', 'summon'] },
    ] },
  { id: 'magma_sovereign', name: 'The Magma Sovereign', texture: 'boss_volcano', hp: 12800, speed: 46, dmg: 60, scale: 1.4,
    phases: [
      { at: 1.0, attacks: ['charge', 'nova'] },
      { at: 0.6, attacks: ['charge', 'nova', 'spiral'] },
      { at: 0.3, attacks: ['charge', 'nova', 'spiral', 'summon'] },
    ] },
  { id: 'dune_colossus', name: 'The Dune Colossus', texture: 'boss_desert', hp: 16000, speed: 42, dmg: 66, scale: 1.5,
    phases: [
      { at: 1.0, attacks: ['spiral', 'charge'] },
      { at: 0.6, attacks: ['spiral', 'charge', 'nova'] },
      { at: 0.3, attacks: ['spiral', 'charge', 'nova', 'summon'] },
    ] },
  { id: 'sky_sovereign', name: 'The Sky Sovereign', texture: 'boss_sky', hp: 22000, speed: 50, dmg: 74, scale: 1.5,
    phases: [
      { at: 1.0, attacks: ['nova', 'spiral'] },
      { at: 0.6, attacks: ['nova', 'spiral', 'charge'] },
      { at: 0.3, attacks: ['nova', 'spiral', 'charge', 'summon'] },
    ] },
  { id: 'judge_of_hoodlust', name: 'The Judge of Hoodlust', texture: 'boss_hoodlust', hp: 32000, speed: 52, dmg: 90, scale: 1.6,
    phases: [
      { at: 1.0, attacks: ['nova', 'charge'] },
      { at: 0.7, attacks: ['nova', 'charge', 'spiral'] },
      { at: 0.45, attacks: ['nova', 'charge', 'spiral', 'summon'] },
      { at: 0.2, attacks: ['nova', 'charge', 'spiral', 'summon'] },
    ] },

  // ===== IMPORTED-SHEET BOSSES — one per map (Boss N → Map N) =====
  // Each is an additional enemy (normal enemies keep spawning). Real animated
  // sprite via `anim`; multi-phase skill sets span long/medium/close range.
  { id: 'boss_e1', name: 'Forest Warden', texture: 'enemy1', anim: 'enemy1', hp: 900, speed: 46, dmg: 12, scale: 0.55,
    phases: [
      { at: 1.0, attacks: ['nova', 'charge'] },
      { at: 0.55, attacks: ['nova', 'charge', 'spiral'] },
      { at: 0.25, attacks: ['nova', 'spiral', 'summon'] },
    ] },
  { id: 'boss_e2', name: 'Garden Revenant', texture: 'enemy2', anim: 'enemy2', hp: 1500, speed: 60, dmg: 15, scale: 0.5,
    phases: [
      { at: 1.0, attacks: ['charge', 'spiral'] },
      { at: 0.6, attacks: ['charge', 'spiral', 'nova'] },
      { at: 0.3, attacks: ['charge', 'spiral', 'nova', 'summon'] },
    ] },
  { id: 'boss_e3', name: 'Void Dragon', texture: 'enemy3', anim: 'enemy3', hp: 2600, speed: 40, dmg: 20, scale: 0.34,
    phases: [
      { at: 1.0, attacks: ['nova', 'spiral'] },
      { at: 0.6, attacks: ['nova', 'spiral', 'charge'] },
      { at: 0.3, attacks: ['nova', 'spiral', 'charge', 'summon'] },
    ] },
  { id: 'boss_e4', name: 'Crystal Sentinel', texture: 'enemy4', anim: 'enemy4', hp: 3400, speed: 52, dmg: 22, scale: 0.52,
    phases: [
      { at: 1.0, attacks: ['spiral', 'nova'] },
      { at: 0.6, attacks: ['spiral', 'nova', 'charge'] },
      { at: 0.3, attacks: ['spiral', 'nova', 'charge', 'summon'] },
    ] },
  { id: 'boss_e5', name: 'Ruin Colossus', texture: 'enemy5', anim: 'enemy5', hp: 4600, speed: 50, dmg: 26, scale: 0.56,
    phases: [
      { at: 1.0, attacks: ['charge', 'nova'] },
      { at: 0.6, attacks: ['charge', 'nova', 'spiral'] },
      { at: 0.3, attacks: ['charge', 'nova', 'spiral', 'summon'] },
    ] },
  { id: 'boss_e6', name: 'Jungle Terror', texture: 'enemy6', anim: 'enemy6', hp: 6200, speed: 74, dmg: 30, scale: 0.56,
    phases: [
      { at: 1.0, attacks: ['charge', 'spiral'] },
      { at: 0.6, attacks: ['charge', 'spiral', 'nova'] },
      { at: 0.3, attacks: ['charge', 'spiral', 'nova', 'summon'] },
    ] },
  { id: 'boss_e7', name: 'Spore Sovereign', texture: 'enemy7', anim: 'enemy7', hp: 8600, speed: 58, dmg: 36, scale: 0.6,
    phases: [
      { at: 1.0, attacks: ['nova', 'summon'] },
      { at: 0.55, attacks: ['nova', 'summon', 'spiral'] },
      { at: 0.25, attacks: ['nova', 'summon', 'spiral', 'charge'] },
    ] },
  { id: 'boss_e8', name: 'Frost Warlord', texture: 'enemy8', anim: 'enemy8', hp: 12000, speed: 52, dmg: 42, scale: 0.7,
    phases: [
      { at: 1.0, attacks: ['spiral', 'charge'] },
      { at: 0.6, attacks: ['spiral', 'charge', 'nova'] },
      { at: 0.3, attacks: ['spiral', 'charge', 'nova', 'summon'] },
...
// Fast lookup by id (biome regions reference their boss by id).
