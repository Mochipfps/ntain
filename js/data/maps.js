...
export const MAPS = {
  ...
  realm_of_hoodlust: {
    id: 'realm_of_hoodlust', name: 'Realm of Hoodlust', grass: 'floor_hoodlust', floorColor: '#1a0a12',
    light: { color: 0xff3a2a, intensity: 0.26, flicker: 0.10 }, ambientColor: '#ff4a3a',
    trees: { count: 0 },
    props: [{ key: 'ruined_tower', count: 20, bw: 14, bh: 14, off: 0.75 }, { key: 'collapsed_wall', count: 16, bw: 26, bh: 10, off: 0.7 }],
    decor: [
      { key: 'statue', count: 20, depth: true }, { key: 'chain', count: 22, depth: true },
      { key: 'torch', count: 24, depth: true, glow: 0xff6a2a }, { key: 'dark_crystal', count: 24, depth: true, glow: 0xff5a8a },
      { key: 'bones', count: 20, depth: true }, { key: 'dead_tree', count: 16, depth: true },
      { key: 'lava_vent', count: 22, depth: true, glow: 0xff4a1a }, { key: 'ancient_door', count: 8, depth: true },
      { key: 'magic_circle', count: 6 },
    ],
    water: { patches: 0 },
    weathers: ['fog', 'wind'], creatures: ['firefly', 'firefly', 'ghostpet'],
    music: { scale: [0, 1, 3, 6, 8], root: 174, tempo: 3.4, wave: 'sawtooth' },
  },
  volcanic_empire: {
...
export const REGIONS = {
  ...
  enchanted_garden: {
    ...
    boss: 'boss_e2',
    features: { boss: true, merchant: true, dungeon: true, secret: true },
  ...
  corrupted_jungle: {
    ...
    features: { boss: true, dungeon: true, secret: true },
    enemies: ['corrupt_spore', 'j_stalker', 'j_spitter'], boss: 'boss_e6',
  ...
  mushroom_forest: {
    ...
    features: { boss: true, dungeon: true, secret: true, night: true },
    enemies: ['myco_crawler', 'm_spore', 'm_sporeling'], boss: 'boss_e7',
  ...
  frozen_wasteland: {
    ...
    enemies: ['ice_shard', 'f_hunter', 'f_howler'], boss: 'boss_e8',
  ...
  sky_kingdom: {
    ...
    links: [{ to: 'crystal_valley', via: 'Airship' }, { to: 'sandstorm_desert', via: 'Airship' }, { to: 'realm_of_hoodlust', via: 'Ancient Gate' }],
  },
  realm_of_hoodlust: {
    id: 'realm_of_hoodlust', map: 'realm_of_hoodlust', name: 'Realm of Hoodlust',
    pos: { x: 3, y: -1 }, danger: 'Judgment', tier: 30, rec: [200, 999], color: '#ff3a3a',
    lore: 'The last realm — a cursed dimension where only the strongest survivors reach the throne of darkness and face the Final Judgment.',
    features: { boss: true, secret: true, night: true },
    enemies: ['doom_knight', 'void_wraith', 'hell_hound'], boss: 'judge_of_hoodlust',
    links: [{ to: 'sky_kingdom', via: 'Ancient Gate' }],
  },
